...
# This is the new regex pattern that should handle trailing whitespace
...
def test_diagnostic_regex_with_type_var_error():
    ...
    assert data["message"] == 'Value of type variable "InstanceT" of "Metadata" cannot be "Condition"', \
...
def test_diagnostic_regex_with_name_defined_error():
    ...
    assert data["code"] == "name-defined", f"Expected code 'name-defined', got {data['code']}"
